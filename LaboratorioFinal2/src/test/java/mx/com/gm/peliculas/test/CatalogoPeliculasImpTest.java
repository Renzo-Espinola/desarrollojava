...
class CatalogoPeliculasImpTest extends CatalogoPeliculasImp {
    ...
    @Test
    public void testListarCatalogo()throws LecturaDatosEx {
    ...
    @Test
    public void testBorrarCatalogo()throws EscrituraDatosEx {
        String esperado ="Se ha borrado el catalogo de pelicula";
        System.out.println("testBorrarCatalogo");
        assertEquals(esperado,catalogoPeliculas.borrarPelicula());
    }
    @Test
    public void testNoBorrarCatalogo()throws EscrituraDatosEx {
        String esperado ="Se produjo un error en el  borrado del catalogo";
        System.out.println("testNoBorrarCatalogo");
        assertNotEquals(esperado,catalogoPeliculas.borrarPelicula());
    }
